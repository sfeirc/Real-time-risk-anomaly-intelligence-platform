...
MARKET_FEATURES = ["zscore", "realized_vol", "spread_bps", "order_imbalance", "throughput_eps", "latency_p99_ms", "error_rate"]
PAYMENTS_FEATURES = ["zscore", "log_mean_amount", "decline_rate", "distinct_accounts", "throughput_eps", "latency_p99_ms", "error_rate"]
...
def to_vector(f: FeatureEvent) -> list[float]:
    if f.domain == "market":
        return [
            f.zscore,
