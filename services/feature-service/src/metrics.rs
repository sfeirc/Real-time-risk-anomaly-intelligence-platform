...
pub struct Metrics {
    ...
    pub clickhouse_write_errors_total: IntCounter,
...
impl Metrics {
    pub fn new() -> Self {
        ...
        let clickhouse_write_errors_total =
            IntCounter::new("feature_clickhouse_write_errors_total", "Failed ClickHouse batch inserts").unwrap();
        let clickhouse_rows_written_total =
            IntCounter::new("feature_clickhouse_rows_written_total", "Rows successfully written to ClickHouse").unwrap();
